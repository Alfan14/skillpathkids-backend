...
async function main() {
    ...
    data: [
      {
        ...
        description:
          "Ajak anak menggunting kertas dengan pola sederhana untuk melatih motorik halus.",
        category: "Motorik Halus",
        duration: "15 Menit",
        iconName: "Scissors",
        isMain: true,
      },
      {
        ...
        title: "Bermain Bola",
        description:
          "Latih koordinasi dan keseimbangan anak dengan bermain lempar tangkap bola.",
        category: "Motorik Kasar",
        duration: "20 Menit",
        iconName: "Circle",
        isMain: false,
      },
      {
        ...
        description:
          "Gunakan benda sekitar rumah untuk mengenalkan warna pada anak.",
        category: "Kognitif",
        duration: "10 Menit",
        iconName: "Palette",
        isMain: false,
    ...
    data: [
      {
        ...
        description:
          "Busy book interaktif bertema hewan untuk membantu anak mengenal nama, bentuk, warna, dan habitat melalui aktivitas mencocokkan dan menempel.",
        shortDescription:
          "Busy book hewan dengan aktivitas matching, sorting, dan vocabulary.",
      ...
      },
      {
        ...
        description:
          "Paket busy book untuk latihan kognitif dasar: bentuk, pola, urutan, perbandingan, dan pemecahan masalah sederhana.",
        shortDescription:
          "Latihan kognitif dasar melalui aktivitas visual yang bertahap.",
        category: "Buku Montessori",
      ...
      },
      {
        ...
        description:
          "Worksheet latihan motorik halus untuk menggunting, menebalkan garis, tracing bentuk, dan koordinasi tangan-mata.",
        shortDescription:
          "Latihan tracing, cutting, dan pre-writing untuk motorik halus.",
      ...
      },
      {
        ...
        description:
          "Bundle lengkap worksheet dan activity book Montessori untuk literasi, numerasi, sensorial, motorik, dan practical life.",
        shortDescription:
          "Bundle lengkap aktivitas Montessori untuk belajar di rumah dan kelas.",
      ...
      },
      {
        ...
        description:
          "Flashcard alfabet printable dengan ilustrasi objek sehari-hari untuk memperkuat pengenalan huruf dan kosakata awal.",
        shortDescription:
          "Flashcard A-Z printable untuk literasi awal anak.",
        category: "Flashcard",
        subCategory: "Alfabet",
        price: 29000,
        discountPrice: null,
      ...
      },
      {
        ...
        description:
          "Worksheet pre-writing untuk melatih kontrol pensil melalui garis lurus, lengkung, zig-zag, bentuk dasar, dan pola berulang.",
        shortDescription:
          "Latihan kontrol pensil dan pola dasar sebelum anak belajar menulis.",
        category: "Worksheet Anak",
  ...
  await prisma.assessmentresult.create({
    data: {
      ...
      categoryResult: "Baik",
      focusSummary:
        "Perkembangan anak sangat baik pada aspek kognitif dan sosial.",
